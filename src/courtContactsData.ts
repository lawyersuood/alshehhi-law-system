...
add({
  ...
  notes:
    "الجهة القضائية المختصة بفض جميع المنازعات الإيجارية في دبي وتنفيذ القرارات الإخلاء والمطالبات",
});
add({
...
const adBranchCourts = [
  ...
  {
    court: "محاكم العين الابتدائية والاستئنافية",
    dept: "مركز خدمة المتعاملين والاستعلامات الرئيسي",
    name: "إسعاد المتعاملين بمحاكم العين",
    tel: "037152000 / 037152222",
    email: "aincourts@adjd.gov.ae",
    loc: "العين - مجمع محاكم العين",
  },
  {
    court: "محاكم العين الابتدائية والاستئنافية",
    dept: "قيد وإدارة الدعاوى المدنية والتجارية والعمالية",
    name: "مكتب إدارة الدعوى بالعين",
    tel: "037152100",
    email: "aincourts@adjd.gov.ae",
    loc: "العين - مجمع محاكم العين",
  },
  {
    court: "محاكم العين الابتدائية والاستئنافية",
    dept: "إدارة التنفيذ والإنابات القضائية بالعين",
    name: "مأمورو التنفيذ والأختام",
    tel: "037152300",
    email: "ain.execution@adjd.gov.ae",
    loc: "العين - مجمع محاكم العين",
  },
  {
    court: "محاكم العين الابتدائية والاستئنافية",
    dept: "الكاتب العدل والتوثيقات العامة بالعين",
    name: "الكاتب العدل بالعين",
    tel: "037152400",
    email: "ain.notary@adjd.gov.ae",
    loc: "العين - مجمع محاكم العين",
  },
  {
    court: "محاكم العين الابتدائية والاستئنافية",
    dept: "التوجيه الأسري وإصلاح ذات البين بالعين",
    name: "قسم الموجهين الأسريين",
    tel: "037152500",
    email: "ain.family@adjd.gov.ae",
    loc: "العين - مجمع محاكم العين",
  },
  {
    court: "محاكم العين الابتدائية والاستئنافية",
    dept: "المحكمة العمالية بالعين",
    name: "أمانة سر القضايا العمالية بالعين",
    tel: "037152600",
    email: "ain.labor@adjd.gov.ae",
    loc: "العين - مجمع محاكم العين",
  },

  // Al Dhafra Courts (محاكم منطقة الظفرة - مدينة زايد)
  {
    court: "محكمة الظفرة الابتدائية",
    dept: "أمانة السر ومركز خدمة المتعاملين الرئيسي",
    name: "أمانة سر محكمة الظفرة",
    tel: "028988888 / 026512000",
    email: "dhafra.court@adjd.gov.ae",
    loc: "الظفرة - مدينة زايد - مجمع المحاكم",
  },
  {
    court: "محكمة الظفرة الابتدائية",
    dept: "إدارة التنفيذ والإنابات القضائية بالظفرة",
    name: "مأمور التنفيذ بالظفرة",
    tel: "028988850",
    email: "dhafra.execution@adjd.gov.ae",
    loc: "الظفرة - مدينة زايد",
  },
  {
    court: "محكمة الظفرة الابتدائية",
    dept: "الكاتب العدل والتوثيقات بالظفرة",
    name: "الكاتب العدل بمدينة زايد",
    tel: "028988820",
    email: "dhafra.notary@adjd.gov.ae",
    loc: "الظفرة - مدينة زايد",
  },
  {
    court: "محكمة الظفرة الابتدائية",
    dept: "نيابة الظفرة الكلية",
    name: "أمانة سر نيابة الظفرة",
    tel: "028988800",
    email: "dhafra.prosecution@adjd.gov.ae",
    loc: "الظفرة - مدينة زايد",
  },
];
adBranchCourts.forEach((b) => {
  add({
    ...
    location: b.loc,
    notes:
      "الخدمات القضائية والدوائر الجزئية والكلية في منطقة " +
      (b.court.includes("العين") ? "العين" : "الظفرة"),
  });
});
const adBailiffs = [
  ...
  {
    dept: "محضر الدعاوى الكلية - الدائرة الأولى (1-2-5-6-7)",
    name: "زليخة فدعق",
    tel: "026513546",
    email: "z.fadaaq@adjd.gov.ae",
  },
  {
    dept: "محضر الدعاوى الكلية - الدائرة الثانية (3-4-8-9-0)",
    name: "حمدان الأحبابي",
    tel: "026513328",
...
const adAppealPrep = [
  {
    dept: "تحضير استئناف أحوال شخصية (0-1-2-3)",
    name: "أحمد العطاس",
    tel: "026512619",
    email: "a.alattas@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف أحوال شخصية (4-5) وإيجارات (0-9)",
    name: "الحبيب ناصر",
    tel: "026512061",
    email: "a.alhayeed@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف أحوال شخصية (6-7-8-9)",
    name: "إسماعيل العامري",
    tel: "026512052",
    email: "i.fadel@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف مدني",
    name: "حامد العيدروس",
    tel: "026513300",
    email: "h.alaidarous@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف مدني وإداري",
    name: "عبدالله البلوشي",
    tel: "026513762",
    email: "Ah.alblooshi@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف تجاري (0-9)",
    name: "شيخة الشحي",
    tel: "026512851 / 026512852",
    email: "Sh.alshehhi@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف تجاري (1-3)",
    name: "رمضان خلف",
    tel: "026513782",
    email: "r.alzahman@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف تجاري (2-4)",
    name: "طارق الحامد",
    tel: "026513753",
    email: "ta.alhamed@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف تجاري (5-7)",
    name: "سلطان التميمي",
    tel: "026512036",
    email: "Su.altamimi@adjd.gov.ae",
  },
  {
    dept: "تحضير استئناف تجاري (6-8)",
    name: "فهد المهري",
    tel: "026512689",
...
const adLaborPrep = [
  ...
  {
    dept: "تحضير عمالي 2-4",
    name: "سعيد الظاهري",
    tel: "0508601003",
    email: "ss.aldhaheri@adjd.gov.ae",
  },
  {
    dept: "تحضير عمالي 5-7",
    name: "محمد العامري",
    tel: "0566666352",
    email: "md.alameri@adjd.gov.ae",
  },
  {
    dept: "تحضير عمالي 6-8",
    name: "خميس الحوسني",
    tel: "026513601",
...
const adCassation = [
  {
    dept: "أمناء السر - الدائرة المدنية والتجارية بنقض أبوظبي",
    name: "أمين سر الدائرة المدنية والتجارية",
    tel: "026512000",
  },
  {
    dept: "أمناء السر - الدائرة الجزائية بنقض أبوظبي",
    name: "أمين سر الدائرة الجزائية",
    tel: "026512000",
  },
  {
    dept: "أمناء السر - دائرة الأحوال الشخصية بنقض أبوظبي",
    name: "أمين سر دائرة الأحوال الشخصية",
    tel: "026512000",
  },
  {
    dept: "أمناء السر - الدائرة الإدارية بنقض أبوظبي",
    name: "أمين سر الدائرة الإدارية",
    tel: "026512000",
  },
  {
    dept: "المكتب الفني لمحكمة النقض بأبوظبي",
    name: "رئيس المكتب الفني والباحثون",
    tel: "026512100",
  },
];
...
const shjMun = [
  {
    dept: "رئيس قسم تصديق العقود الإيجارية",
    name: "حامد القائد",
    tel: "065931588",
    email: "Hamid.alqayed@shjmun.gov.ae",
  },
  {
    dept: "رئيس قسم تنظيم العقود الإيجارية",
    name: "وفاء المالكي",
    tel: "065931540",
    email: "Wafa.essa@shjmun.gov.ae",
  },
  {
    dept: "رئيس قسم تنفيذ المنازعات الإيجارية",
    name: "ندى العليلي",
    tel: "065931510",
    email: "Nada.alili@shjmun.gov.ae",
  },
  {
    dept: "رئيس قسم فض المنازعات الإيجارية",
    name: "طارق الزرعوني",
    tel: "065931514",
    email: "Tariq.zarouni@shjmun.gov.ae",
  },
  {
    dept: "تنفيذ المنازعات الإيجارية",
    name: "موزة خلفان / محمد الأغبري",
    tel: "065931628 / 065931623",
    email: "execution@shjmun.gov.ae",
  },
  {
    dept: "تنظيم العقود الإيجارية",
    name: "لبنى الشامسي",
    tel: "065931548",
  ...
  {
    dept: "قسم فض المنازعات الإيجارية",
    name: "إبراهيم العبيدلي",
    tel: "065931512",
    email: "Ibrahim.obaidly@shjmun.gov.ae",
  },
  {
    dept: "فض المنازعات الإيجارية",
    name: "بنا الحوساني",
    tel: "065931515",
    email: "banna.hosany@shjmun.gov.ae",
  },
  {
    dept: "قسم تنفيذ المنازعات الإيجارية",
    name: "علي خلف",
    tel: "065931620",
...
const shjBranchCourts = [
  ...
  {
    court: "محكمة الذيد الجزئية",
    dept: "قيد وتسجيل الدعاوى والطلبات القضائية بالذيد",
    name: "موظف القيد: سيف الطنيجي",
    tel: "068032740",
    email: "smalteneiji@moj.gov.ae",
    loc: "الذيد - مجمع المحاكم بالمنطقة الوسطى",
  },
  {
    court: "محكمة الذيد الجزئية",
    dept: "أمناء السر - الجلسات والدوائر الجزائية والمدنية",
    name: "أمين السر: حمد الطنيجي",
    tel: "068032729",
    email: "Hmalteneiji@moj.gov.ae",
    loc: "الذيد - مجمع المحاكم",
  },
  {
    court: "محكمة الذيد الجزئية",
    dept: "أمناء السر - الأحوال الشخصية والتوثيقات الشرعية",
    name: "أمين السر: سالم المرزوقي",
    tel: "068032711",
  ...
  {
    court: "محكمة الذيد الجزئية",
    dept: "إدارة التنفيذ والإنابات القضائية بالذيد",
    name: "مأمور التنفيذ بالذيد",
    tel: "068032750",
    email: "dhaid.execution@moj.gov.ae",
    loc: "الذيد - مجمع المحاكم",
  },
  {
    court: "محكمة الذيد الجزئية",
    dept: "الكاتب العدل والتوثيقات العامة بالذيد",
    name: "الكاتب العدل بالذيد",
    tel: "068032730",
    email: "dhaid.notary@moj.gov.ae",
    loc: "الذيد - مجمع المحاكم",
  },
  {
    court: "محكمة الذيد الجزئية",
    dept: "نيابة الذيد الجزئية",
    name: "أمانة سر نيابة الذيد",
    tel: "068822200 / 068822222",
    email: "dhaid.prosecution@pp.gov.ae",
    loc: "الذيد - مجمع النيابات",
  },

  // 2. Khorfakkan Court (محكمة خورفكان الكلية والاستئنافية - المنطقة الشرقية)
  {
    court: "محكمة خورفكان الاتحادية الابتدائية والاستئنافية",
    dept: "مركز خدمة المتعاملين والاستعلامات الرئيسي",
    name: "أمانة سر محكمة خورفكان",
    tel: "092386111 / 092387777",
    email: "khorfakkan.court@moj.gov.ae",
    loc: "خورفكان - مجمع المحاكم الاتحادية",
  },
  {
    court: "محكمة خورفكان الاتحادية الابتدائية والاستئنافية",
    dept: "قيد وإدارة الدعاوى المدنية والتجارية",
    name: "مكتب إدارة الدعوى بخورفكان",
    tel: "092386120",
    email: "khorfakkan.court@moj.gov.ae",
    loc: "خورفكان - مجمع المحاكم",
  },
  {
    court: "محكمة خورفكان الاتحادية الابتدائية والاستئنافية",
    dept: "أمناء السر - الدوائر الجزائية والجنائية والجنح",
    name: "أمين سر الجنايات والجنح",
    tel: "092386135",
    email: "khorfakkan.court@moj.gov.ae",
    loc: "خورفكان - مجمع المحاكم",
  },
  {
    court: "محكمة خورفكان الاتحادية الابتدائية والاستئنافية",
    dept: "إدارة التنفيذ والإنابات بخورفكان",
    name: "مأمورو التنفيذ والأختام",
    tel: "092386130",
    email: "khorfakkan.execution@moj.gov.ae",
    loc: "خورفكان - مجمع المحاكم",
  },
  {
    court: "محكمة خورفكان الاتحادية الابتدائية والاستئنافية",
    dept: "الكاتب العدل والتوثيقات بخورفكان",
    name: "الكاتب العدل بخورفكان",
    tel: "092386150",
    email: "khorfakkan.notary@moj.gov.ae",
    loc: "خورفكان - مجمع المحاكم",
  },
  {
    court: "محكمة خورفكان الاتحادية الابتدائية والاستئنافية",
    dept: "نيابة خورفكان الكلية",
    name: "أمانة سر نيابة خورفكان",
    tel: "092386200",
    email: "khorfakkan.prosecution@pp.gov.ae",
    loc: "خورفكان - مجمع النيابات",
  },

  // 3. Kalba Court (محكمة كلباء الجزئية - المنطقة الشرقية)
  {
    court: "محكمة كلباء الجزئية",
    dept: "أمانة سر المحكمة والخدمات القضائية",
    name: "أمين السر: أحمد المازمي",
    tel: "092778114 / 092778100",
    email: "kalba.court@moj.gov.ae",
    loc: "كلباء - مجمع المحاكم",
  },
  {
    court: "محكمة كلباء الجزئية",
    dept: "قيد وإدارة الدعاوى والتوثيقات بكلباء",
    name: "موظف القيد وإدارة الدعوى",
    tel: "092778120",
    email: "kalba.court@moj.gov.ae",
    loc: "كلباء - مجمع المحاكم",
  },
  {
    court: "محكمة كلباء الجزئية",
    dept: "الكاتب العدل والتوثيقات بكلباء",
    name: "الكاتب العدل بكلباء",
    tel: "092778130",
    email: "kalba.notary@moj.gov.ae",
    loc: "كلباء - مجمع المحاكم",
  },
  {
    court: "محكمة كلباء الجزئية",
    dept: "نيابة كلباء الجزئية",
    name: "أمانة سر نيابة كلباء",
    tel: "092778200",
    email: "kalba.prosecution@pp.gov.ae",
    loc: "كلباء - مجمع النيابات",
  },

  // 4. Dibba Al Hisn Court (محكمة دبا الحصن الجزئية - المنطقة الشرقية)
  {
    court: "محكمة دبا الحصن الجزئية",
    dept: "أمانة السر وقيد الدعاوى والخدمات القضائية",
    name: "أمانة سر محكمة دبا الحصن",
    tel: "092053600 / 092053629",
    email: "dibbahisn.court@moj.gov.ae",
    loc: "دبا الحصن - مجمع الدوائر الحكومية",
  },
  {
    court: "محكمة دبا الحصن الجزئية",
    dept: "الكاتب العدل والتوثيق والعرائض بدبا الحصن",
    name: "الكاتب العدل بدبا الحصن",
    tel: "092053610",
    email: "dibbahisn.notary@moj.gov.ae",
    loc: "دبا الحصن - مجمع الدوائر الحكومية",
  },
  {
    court: "محكمة دبا الحصن الجزئية",
    dept: "نيابة دبا الحصن الجزئية",
    name: "أمانة سر نيابة دبا الحصن",
    tel: "092053650",
    email: "dibbahisn.prosecution@pp.gov.ae",
    loc: "دبا الحصن - مجمع النيابات",
  },

  // 5. Al Madam Court (محكمة المدام الجزئية - المنطقة الوسطى)
  {
    court: "محكمة المدام الجزئية",
    dept: "مكتب المحكمة والخدمات القضائية وقيد الدعاوى",
    name: "مسؤول محكمة المدام",
    tel: "068828000",
    email: "almadam.court@moj.gov.ae",
    loc: "المدام - المنطقة الوسطى",
  },
  {
    court: "محكمة المدام الجزئية",
    dept: "الكاتب العدل والتوثيقات العامة بالمدام",
    name: "الكاتب العدل بالمدام",
    tel: "068828010",
    email: "almadam.notary@moj.gov.ae",
    loc: "المدام - المنطقة الوسطى",
  },
  {
    court: "محكمة المدام الجزئية",
    dept: "نيابة المدام الجزئية",
    name: "أمانة سر نيابة المدام",
    tel: "068828020",
    email: "almadam.prosecution@pp.gov.ae",
    loc: "المدام - المنطقة الوسطى",
  },
];
...
const ajmanCourts = [
  {
    dept: "أمين سر - الدوائر المدنية والتجارية",
    name: "عبدالله المازمي",
    tel: "067035624",
    email: "aalmazmi@moj.gov.ae",
  },
  {
    dept: "أمين سر - الدوائر العمالية",
    name: "أحمد صبري",
    tel: "067035625",
    email: "asabri@moj.gov.ae",
  },
  {
    dept: "أمين سر - دوائر الجنايات والجنح",
    name: "حسين الشحي",
    tel: "067035626",
    email: "hshahi@moj.gov.ae",
  },
  {
    dept: "أمين سر - الأحوال الشخصية والتوجيه الأسري",
    name: "حميد المازمي",
    tel: "067035627",
    email: "hmazmi@moj.gov.ae",
  },
  {
    dept: "إدارة التنفيذ والإنابات القضائية بعجمان",
    name: "مأمورو التنفيذ والأختام",
    tel: "067035600",
    email: "execution.ajm@moj.gov.ae",
  },
  {
    dept: "الكاتب العدل والتوثيقات بعجمان",
    name: "الكاتب العدل العام",
    tel: "067035650",
    email: "notary.ajm@moj.gov.ae",
  },
  {
    dept: "نيابة عجمان الكلية والاستئنافية",
    name: "أمانة سر النيابة الكلية",
    tel: "067035700",
    email: "ajman.prosecution@pp.gov.ae",
  },
];
...
const rakClerks = [
  ...
  {
    dept: "أمين سر الاستئناف الجزائي - الدائرة الثانية",
    name: "سعيد راشد الوالي",
    tel: "072070512",
  },
  {
    dept: "أمين سر الاستئناف العمالي الكلي - الدائرة الأولى",
    name: "حمد محمد الزعابي",
    tel: "072070518",
  },
  {
    dept: "أمين سر الاستئناف العمالي الكلي - الدائرة الثانية",
    name: "جمال محمد الطنيجي",
    tel: "072070515",
  },
  {
    dept: "أمين سر الاستئناف المدني والتجاري - الدائرة الأولى",
    name: "عبدالله حسن الحبسي",
    tel: "072070525",
  },
  {
    dept: "أمين سر الاستئناف المدني والتجاري - الدائرة الثانية",
    name: "سلطان حسن بني شميلي",
    tel: "072070524",
  },
  {
    dept: "أمين سر الاستئناف المدني والتجاري - الدائرة الثالثة",
    name: "محمد راشد الشحي",
    tel: "072070528",
  },
  { dept: "أمين سر استئناف الأحوال الشخصية", name: "أحمد سيف", tel: "072070471" },
  {
    dept: "أمين سر محكمة التمييز المدنية والتجارية",
    name: "أمين سر دائرة التمييز",
    tel: "072070500",
  },
  {
    dept: "أمين سر محكمة التمييز الجزائية",
    name: "أمين سر دائرة التمييز الجزائي",
    tel: "072070501",
  },
  ...
  {
    dept: "إدارة الكاتب العدل والتوثيقات برأس الخيمة",
    name: "الكاتب العدل العام",
    tel: "072070400",
  },
  {
    dept: "إدارة التوجيه والإصلاح الأسري برأس الخيمة",
    name: "قسم الموجهين الأسريين",
    tel: "072070450",
  },
  {
    dept: "مركز الاتصال وخدمة المتعاملين بمحاكم رأس الخيمة",
    name: "إسعاد المتعاملين",
    tel: "072070000 / 072070111",
    email: "info@rakcourts.rak.ae",
  },
];
rakClerks.forEach((r) => {
  add({
...
const uaqCourts = [
  {
    dept: "استعلامات ومركز خدمة المتعاملين",
    name: "مركز خدمة المتعاملين",
    tel: "067656666",
    email: "uaq.court@moj.gov.ae",
  },
  {
    dept: "أمناء السر - المدني والتجاري والعمالي",
    name: "أمين سر المحكمة",
    tel: "067656601",
    email: "uaq.court@moj.gov.ae",
  },
  {
    dept: "أمناء السر - الجزائي والجنايات والجنح",
    name: "أمين سر الجزائي",
    tel: "067656602",
    email: "uaq.court@moj.gov.ae",
  },
  {
    dept: "أمناء السر - الأحوال الشخصية والتوجيه الأسري",
    name: "أمين سر الأحوال الشخصية",
    tel: "067656603",
    email: "uaq.court@moj.gov.ae",
  },
  {
    dept: "إدارة التنفيذ والإنابات القضائية",
    name: "مأمورو التنفيذ",
    tel: "067656620",
    email: "execution.uaq@moj.gov.ae",
  },
  {
    dept: "الكاتب العدل والتوثيقات بأم القيوين",
    name: "الكاتب العدل العام",
    tel: "067656630",
    email: "notary.uaq@moj.gov.ae",
  },
  {
    dept: "محكمة فلج المعلا الجزئية",
    name: "مكتب المحكمة والخدمات القضائية",
    tel: "067681444",
    email: "falaj.court@moj.gov.ae",
  },
  {
    dept: "نيابة أم القيوين الكلية",
    name: "أمانة سر النيابة",
    tel: "067656700",
    email: "uaq.prosecution@pp.gov.ae",
  },
];
uaqCourts.forEach((u) => {
  add({
    courtName: u.dept.includes("فلج")
      ? "محكمة فلج المعلا الجزئية"
      : "محكمة أم القيوين الاتحادية الابتدائية والاستئنافية",
    emirate: "أم القيوين",
    department: u.dept,
...
const fujCourts = [
  {
    dept: "رئيس محكمة الفجيرة الابتدائية وسكرتاريته",
    name: "سعادة رئيس المحكمة / أحمد المسماري",
    tel: "092015202 / 092015203",
    email: "president.fuj@moj.gov.ae",
  },
  {
    dept: "إدارة الخدمات المساندة والاستعلامات والشكاوى",
    name: "مريم اليماحي / استعلامات المحكمة",
    tel: "092015206 / 092015200 / 092015205",
    email: "complaints@moj.gov.ae",
  },
  {
    dept: "أمناء السر - مدني وتجاري وعمالي",
    name: "أحمد راشد",
    tel: "092015214",
  ...
  {
    dept: "أمين سر دائرة الجنايات المستأنفة",
    name: "أحمد اليماحي",
    tel: "092015263",
    email: "aalyamahi@moj.gov.ae",
  },
  {
    dept: "أمين سر دائرة الأحوال الشخصية المستأنفة",
    name: "حمدان الكعبي",
    tel: "092015264",
    email: "halkaabi@moj.gov.ae",
  },
  {
    dept: "أمين سر الدائرة العمالية المستأنفة",
    name: "سلطان الظنحاني",
    tel: "092015265",
    email: "sdhanhani@moj.gov.ae",
  },
  {
    dept: "أمين سر الدائرة التجارية المستأنفة",
    name: "فيصل الحمودي",
    tel: "092015266",
    email: "falhamoudi@moj.gov.ae",
  },
  {
    dept: "أمين سر التوجيه الأسري",
    name: "راشد عبيد / محمد الحفيتي / مريم المسماري",
    tel: "092015292 / 092015293 / 092015294",
    email: "ralobaid@moj.gov.ae",
  },
  { dept: "مصلح أسري", name: "موزة اليماحي", tel: "092015295", email: "malyamahi@moj.gov.ae" },
  {
    dept: "أمين سر التوثيقات وعقود الزواج",
    name: "حصة الكعبي",
    tel: "092015277",
    email: "halkaabi@moj.gov.ae",
  },
  {
    dept: "رئيس قسم التنفيذ وأمناء سر التنفيذ",
    name: "علي اليماحي / أحمد الحفيتي / خالد الزيودي / سعيد الصريدي",
    tel: "092015236 / 092015226 / 092015227 / 092015228",
    email: "aalyamahi@moj.gov.ae",
  },
  {
    dept: "الإيداعات والتحويلات البنكية والمحاسبة",
    name: "فاطمة الحمودي / سالم الظنحاني",
    tel: "092015233 / 092015234",
    email: "falhamoudi@moj.gov.ae",
  },
  {
    dept: "استعلامات مركز التوفيق والمصالحة",
    name: "موظف المركز",
    tel: "092015280",
    email: "info@moj.gov.ae",
  },
  {
    dept: "محكمة دبا الفجيرة الاتحادية الابتدائية",
    name: "أمانة سر محكمة دبا الفجيرة",
    tel: "092045500 / 092045529",
    email: "dibba.court@moj.gov.ae",
  },
];
fujCourts.forEach((f) => {
  add({
    courtName: f.dept.includes("دبا")
      ? "محكمة دبا الفجيرة الاتحادية الابتدائية"
      : "محكمة الفجيرة الاتحادية الابتدائية والاستئنافية",
    emirate: "الفجيرة",
    department: f.dept,
...
const penalEstabs = [
  ...
  },
  {
    ...
    email:
      "SERVICES.CPOD@SHJPOLICE.GOV.AE / Inmateaffair.cpod@shjpolice.gov.ae / Central.jail4@gmail.com",
    hours: "07:30 ص - 02:30 م",
  ...
  },
  {
    ...
    email:
      "albuhairaps@shjpolice.gov.ae / Wasit.cpod@shjpolice.gov.ae / Khor.police@shjpolice.gov.ae",
    hours: "24/7",
