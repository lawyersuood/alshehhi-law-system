...
export const DETAILED_ACTION_PERMISSIONS: Array<{
  ...
  { id: "manageLetterheadAssets", label: "إدارة الهوية الرسمية (الورق والتوقيع والختم)", desc: "صلاحية حساسة لرفع أو تغيير صور الورق الرسمي والتوقيع والختم المعتمدة، من قسم الهوية الرسمية المحمي", category: "النظام والأمان", isSensitive: true },
  { id: "useSignatureStamp", label: "إدراج التوقيع والختم في المستندات الصادرة", desc: "السماح للمستخدم بإدراج صورة التوقيع والختم الرسمية المعتمدة عند إصدار الخطابات والإنابات والاتفاقيات، دون منحه صلاحية تعديل أو استبدال هذه الصور", category: "النظام والأمان" },
...
export const PERMISSION_LABELS: Record<keyof RolePermissions, { label: string; desc: string }> = {
  ...
  colleagues: { label: "19. الزملاء والإنابات", desc: "دليل المحامين المتعاونين وإصدار إنابات الحضور بالجلسات" },
  ...
  manageColleagues: { label: "إدارة الزملاء وإصدار الإنابات", desc: "إضافة وتعديل بيانات المحامين المتعاونين وإصدار إنابات الحضور" },
  manageLetterheadAssets: { label: "إدارة الهوية الرسمية (الورق والتوقيع والختم)", desc: "صلاحية حساسة لرفع أو تغيير صور الورق الرسمي والتوقيع والختم المعتمدة" },
  useSignatureStamp: { label: "إدراج التوقيع والختم في المستندات الصادرة", desc: "السماح بإدراج التوقيع والختم المعتمدين عند إصدار المستندات" },
  ...
  deleteColleagues: { label: "حذف بيانات الزملاء والإنابات", desc: "حذف بيانات الزملاء والإنابات الصادرة" },
