...
const TASK_PRIORITY: Record<string, string> = {
  ...
  منخفضة: "bg-emerald-100 text-emerald-700",
};
const DOC_TYPES = [
  "صحيفة دعوى",
  "مذكرة جوابية",
...
const seedClients: Client[] = [
  {
    id: 1,
    name: "شركة الخليج للمقاولات ذ.م.م",
    type: "شركة",
    idNo: "رخصة تجارية 784512",
    phone: "04-3345678",
    email: "info@gulfcon.ae",
    emirate: "دبي",
    address: "الخليج التجاري، برج المنارة",
  },
  {
    id: 2,
    name: "أحمد عبدالله المنصوري",
    type: "فرد",
    idNo: "784-1985-1234567-1",
    phone: "050-1234567",
  ...
  {
    id: 3,
    name: "مؤسسة النخيل العقارية",
    type: "شركة",
    idNo: "رخصة تجارية 552314",
    phone: "06-5567890",
    email: "legal@nakheel-re.ae",
    emirate: "الشارقة",
    address: "المجاز 3",
  },
  {
    ...
    type: "فرد",
    idNo: "784-1990-7654321-2",
    phone: "055-9876543",
    email: "fatima.s@email.ae",
    emirate: "دبي",
    address: "جميرا 1",
  },
];
...
const seedCases: CaseItem[] = [
  {
    id: 1,
    number: "1245/2026 تجاري كلي",
    clientId: 1,
    opponent: "شركة الاتحاد للتطوير",
    type: "تجاري",
    court: "محاكم دبي",
    judge: "الدائرة التجارية الثالثة",
    status: "متداولة",
    subject: "مطالبة بمستحقات مقاولة بقيمة 2,400,000 د.إ",
    openDate: "2026-01-14",
    fee: 0,
  },
  {
    id: 2,
    number: "3387/2026 عمالي جزئي",
    clientId: 2,
    opponent: "شركة المستقبل للتقنية",
    type: "عمالي",
    court: "محاكم دبي",
    judge: "الدائرة العمالية الأولى",
    status: "قيد النظر",
    subject: "مطالبة بمستحقات نهاية الخدمة وبدل إنذار",
    openDate: "2026-03-02",
    fee: 0,
  },
  {
    id: 3,
    number: "778/2026 إيجاري",
    clientId: 3,
    opponent: "مستأجر - محل تجاري",
    type: "إيجاري",
    court: "مركز فض المنازعات الإيجارية - دبي",
    judge: "اللجنة القضائية الثانية",
    status: "محجوزة للحكم",
    subject: "إخلاء لعدم سداد الأجرة وإلزام بالمتأخرات",
    openDate: "2026-02-10",
    fee: 0,
  },
  {
    id: 4,
    number: "512/2026 أحوال شخصية",
    clientId: 4,
    opponent: "—",
    type: "أحوال شخصية",
    court: "دائرة القضاء - أبوظبي",
    judge: "دائرة الأحوال الشخصية",
    status: "متداولة",
    subject: "دعوى نفقة وحضانة",
    openDate: "2026-04-20",
    fee: 0,
  },
  {
    id: 5,
    number: "204/2025 تنفيذ تجاري",
    clientId: 1,
    ...
    judge: "قاضي التنفيذ",
    status: "تنفيذ",
    subject: "تنفيذ حكم بمبلغ 850,000 د.إ",
    openDate: "2025-11-05",
    fee: 0,
  },
];
...
const seedHearings: Hearing[] = [
  {
    ...
    time: "09:30",
    type: "جلسة مرافعة",
    room: "قاعة 7 - الطابق 3",
    notes: "تقديم مذكرة الرد على تقرير الخبير",
    done: false,
  },
  {
    id: 2,
    ...
    date: addDays(5),
    time: "10:00",
    type: "جلسة إدارة دعوى",
    room: "قاعة إدارة الدعوى 2",
    notes: "جلسة أولى — إعلان المدعى عليه",
    done: false,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    time: "09:00",
    type: "جلسة صلح",
    room: "لجنة التوجيه الأسري",
    notes: "تعذر الصلح وإحالة الدعوى للمحكمة",
    done: true,
  },
];
...
const seedInvoices: Invoice[] = [
  {
    ...
    amount: 60000,
    status: "مدفوعة",
    desc: "دفعة أولى من أتعاب المحاماة",
  },
  {
    id: 2,
    number: "INV-2026-052",
...
const seedDocs: DocItem[] = [
  {
    id: 1,
    name: "صحيفة الدعوى التجارية 1245-2026.pdf",
    type: "صحيفة دعوى",
    caseId: 1,
    date: "2026-01-14",
    by: "سعود أحمد الشحي",
  ...
  {
    id: 3,
    name: "عقد الإيجار الموثق - إيجاري.pdf",
    type: "عقد",
    caseId: 3,
    date: "2026-02-10",
    by: "نورة العلي",
  ...
  {
    id: 4,
    name: "إنذار عدلي بالسداد أو الإخلاء.pdf",
    type: "إنذار عدلي",
    caseId: 3,
    date: "2026-01-25",
    by: "الكاتب العدل",
...
const seedPoas: PoaItem[] = [
  {
    id: 1,
    clientId: 1,
    number: "وكالة 2025/1/88412",
    issuer: "كاتب العدل - دبي",
    issue: "2025-09-10",
    expiry: addDays(45),
    scope: "وكالة قضائية عامة — الترافع أمام جميع المحاكم",
  },
  {
    id: 2,
    clientId: 2,
    number: "وكالة 2026/2/1174",
    issuer: "كاتب العدل - أبوظبي",
    issue: "2026-02-15",
    expiry: "2028-02-15",
    scope: "وكالة خاصة — الدعوى العمالية رقم 3387/2026",
  },
  {
    id: 3,
    clientId: 4,
    number: "وكالة 2026/1/3390",
    issuer: "كاتب العدل - دبي",
    issue: "2026-04-01",
    expiry: addDays(20),
    scope: "وكالة خاصة — أحوال شخصية مع حق الصلح والإقرار",
  },
];
...
const Modal = ({
  ...
  >
    <div
      className={`max-h-[90vh] w-full ${wide ? "max-w-3xl" : "max-w-xl"} overflow-y-auto rounded-2xl bg-white shadow-2xl`}
...
export default function LawFirmUAE() {
  ...
  const checkPerm = (permKey: keyof RolePermissions, actionName: string): boolean => {
    if (!userPerms[permKey]) {
      setPermissionNotice(
        `عذرًا، حساب "${currentUser.name}" دور (${currentUser.roleTitle}) لا يمتلك صلاحية [${PERMISSION_LABELS[permKey].label}]. يُرجى التبديل لحساب المدير لتجربتها.`,
      );
      return false;
    }
    return true;
  ...
  const stats = useMemo(() => {
    ...
    const dueAmount = invoices
      .filter((i) => ["مرسلة", "متأخرة"].includes(i.status))
  ...
  const saveCase = () => {
    ...
    setCases([
      ...cases,
      {
        ...
        judge: form.judge || "",
        status: form.status || "قيد النظر",
        subject: form.subject || "",
        openDate: form.openDate || todayISO(),
        fee: +form.fee || 0,
      },
    ]);
    setModal(null);
  ...
  const saveInvoice = () => {
    ...
    setInvoices([
      ...
      {
        id: nextId(invoices),
        number: `INV-2026-${String(60 + nextId(invoices)).padStart(3, "0")}`,
        clientId: +form.clientId,
        caseId: form.caseId ? +form.caseId : null,
        date: todayISO(),
  ...
  const filteredCases = cases.filter(
    (c) =>
      ...
      (c.number.includes(q) ||
        clientName(c.clientId).includes(q) ||
  ...
  return (
    <div
      dir="rtl"
      className="min-h-screen bg-stone-100 text-slate-800 font-sans selection:bg-amber-200 rounded-2xl overflow-hidden border border-slate-200"
    >
          ...
          <nav className="flex-1 space-y-1 p-3">
            {NAV.map(({ id, label, icon: Icon }) => (
              ...
              >
                ...
                {id === "users" && (
                  <span className="mr-auto rounded-full bg-slate-800 border border-amber-500/40 text-[10px] px-1.5 py-0.2 text-amber-300 font-mono">
                    {users.length}
                  </span>
                )}
              </button>
        ...
        <main className="flex-1">
          ...
          <header className="sticky top-0 z-20 flex items-center gap-3 border-b border-slate-200 bg-white/90 px-4 py-3 backdrop-blur md:px-6">
            ...
            <div className="flex items-center gap-2 border-r border-slate-200 pr-3 mr-2">
              <div
                className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold ${currentUser.avatarBg}`}
              >
                ...
                <div className="flex flex-wrap items-end justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      نظرة عامة على أعمال المكتب والملفات القانونية والجلسات
                    </p>
                  </div>
                  <button
                ...
                <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
                  {[
                    ...
                    },
                    {
                      ...
                      value: stats.weekHearings,
                      icon: Gavel,
                      tone: "bg-amber-100 text-amber-600",
                    },
                    {
                      label: "مبالغ مستحقة (شامل الضريبة 5%)",
                      value: fmtAED(stats.dueAmount),
                      icon: TrendingUp,
                      tone: "bg-emerald-100 text-emerald-600",
                    },
                    {
                      label: "وكالات تنتهي خلال 60 يومًا",
                      value: stats.expiringPoa,
                      icon: AlertTriangle,
                    ...
                    >
                      <div
                        className={`mb-3 flex h-10 w-10 items-center justify-center rounded-xl ${k.tone}`}
                      >
                        <k.icon size={20} />
                      </div>
              ...
              <>
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      قيد ومتابعة ملفات القضايا أمام المحاكم الإماراتية
                    </p>
                  </div>
                  <button
                    onClick={() => openModalWithCheck("case", "manageCases")}
                ...
                <div className="flex flex-wrap gap-2">
                  {["الكل", ...CASE_STATUS].map((s) => (
                    <button
                      ...
                      className={`rounded-full px-3.5 py-1.5 text-xs font-semibold transition ${caseFilter === s ? "bg-slate-900 text-white" : "bg-white text-slate-600 hover:bg-slate-200"}`}
                    >
                      {s}
                    </button>
                  ))}
                      ...
                      {filteredCases.map((c) => (
                        <tr key={c.id} className="transition hover:bg-amber-50/60">
                          ...
                          <td className="px-4 py-3">
                            <Badge className="bg-slate-100 text-slate-600">{c.type}</Badge>
                          </td>
                          <td className="px-4 py-3">
            ...
            {tab === "users" && (
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl bg-gradient-to-l from-slate-900 to-slate-800 text-white shadow-md flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 text-xs bg-slate-800/80 p-2 rounded-xl border border-slate-700">
                    ...
                    <span>
                      الصلاحيات المتاحة:{" "}
                      <b>
                        {Object.values(currentUser.permissions).filter(Boolean).length} من{" "}
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
                  <div>
                    <h3 className="font-bold text-slate-900 text-base">
                      مصفوفة التحكم التفاعلية بالصلاحيات (Permission Matrix)
                    </h3>
                    <p className="text-xs text-slate-500">
                      يمكنك الضغط على خانة أي صلاحية لتفعيلها أو إلغائها فورًا لكل عضو
                    </p>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full text-xs">
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {(Object.keys(PERMISSION_LABELS) as Array<keyof RolePermissions>).map(
                          (pKey) => (
                            <tr key={pKey} className="hover:bg-slate-50">
                              <td className="p-3 font-semibold text-slate-800">
                                <p className="font-bold text-slate-900">
                                  {PERMISSION_LABELS[pKey].label}
                                </p>
                                <p className="text-[11px] text-slate-400 font-normal">
                                  {PERMISSION_LABELS[pKey].desc}
                                </p>
                              </td>
                              {users.map((u) => {
        ...
        >
          <div className="space-y-4 text-sm">
            ...
            <Field label="الدور / القالب المسبق">
              <select
                onChange={f("roleKey")}
                defaultValue={form.roleKey || "lawyer"}
                className={inputCls}
              >
