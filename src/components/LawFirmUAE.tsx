...
const seedCases: CaseItem[] = [
  { id: 1, number: "1245/2026 تجاري كلي", clientId: 1, opponent: "شركة الاتحاد للتطوير", type: "تجاري", court: "محاكم دبي", judge: "الدائرة التجارية الثالثة", status: "متداولة", subject: "مطالبة بمستحقات مقاولة بقيمة 2,400,000 د.إ", openDate: "2026-01-14", fee: 120000 },
  { id: 2, number: "3387/2026 عمالي جزئي", clientId: 2, opponent: "شركة المستقبل للتقنية", type: "عمالي", court: "محاكم دبي", judge: "الدائرة العمالية الأولى", status: "قيد النظر", subject: "مطالبة بمستحقات نهاية الخدمة وبدل إنذار", openDate: "2026-03-02", fee: 15000 },
  { id: 3, number: "778/2026 إيجاري", clientId: 3, opponent: "مستأجر - محل تجاري", type: "إيجاري", court: "مركز فض المنازعات الإيجارية - دبي", judge: "اللجنة القضائية الثانية", status: "محجوزة للحكم", subject: "إخلاء لعدم سداد الأجرة وإلزام بالمتأخرات", openDate: "2026-02-10", fee: 25000 },
  { id: 4, number: "512/2026 أحوال شخصية", clientId: 4, opponent: "—", type: "أحوال شخصية", court: "دائرة القضاء - أبوظبي", judge: "دائرة الأحوال الشخصية", status: "متداولة", subject: "دعوى نفقة وحضانة", openDate: "2026-04-20", fee: 20000 },
  { id: 5, number: "204/2025 تنفيذ تجاري", clientId: 1, opponent: "شركة البناء الحديث", type: "تنفيذ", court: "محاكم دبي", judge: "قاضي التنفيذ", status: "تنفيذ", subject: "تنفيذ حكم بمبلغ 850,000 د.إ", openDate: "2025-11-05", fee: 40000 },
];
