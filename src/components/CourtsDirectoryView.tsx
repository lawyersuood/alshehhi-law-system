...
export interface CourtsDirectoryViewProps {
  ...
  courtContactsFilterCache: React.MutableRefObject<{ contacts: CourtContact[]; query: string; emirate: string; category: string; branch: string; result: CourtContact[] } | null>;
