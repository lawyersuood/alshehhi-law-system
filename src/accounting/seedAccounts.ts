...
const seed: SeedNode[] = [
  ...
  { key: "121", parentKey: "12", code: "121", name: "أثاث و معدات", type: "asset" },
  {
    ...
    parentKey: "12",
    code: "122",
    name: "مجمع الإهلاك التراكمي",
    type: "asset",
    isGroup: true,
    notes: "حساب مقابل (Contra)، رصيده الطبيعي دائن",
  },
  ...
  { key: "211", parentKey: "21", code: "211", name: "الموردين", type: "liability", isGroup: true },
  {
    ...
    parentKey: "211",
    code: "2110",
    name: "ضريبة القيمة المضافة على الحسابات الدائنة",
    type: "liability",
  },
  ...
  { key: "217", parentKey: "21", code: "217", name: "Customer expense payable", type: "liability" },
  {
    ...
    name: "القيمة المضافة",
    type: "liability",
    notes: "ضريبة القيمة المضافة — مخرجات (مستحقة للهيئة)",
  },
  {
    key: "219",
    parentKey: "21",
    code: "219",
    name: "ضريبة السلع الانتقائية المستحقة",
    type: "liability",
  },
  ...
  { key: "3", parentKey: null, code: "3", name: "حقوق الملكية", type: "equity", isGroup: true },
  {
    ...
    parentKey: "3",
    code: "31",
    name: "حقوق ملكية من رصيد إفتتاحي",
    type: "equity",
    isGroup: true,
  },
  ...
  { key: "321", parentKey: "32", code: "321", name: "رأس المال", type: "equity" },
  {
    ...
    name: "المسحوبات",
    type: "equity",
    notes: "رصيده الطبيعي مدين، يخصم من حقوق الملكية",
  },
  {
    key: "33",
    parentKey: "3",
  ...
  { key: "331", parentKey: "33", code: "331", name: "الأرباح المحتجزة", type: "equity" },
  {
    ...
    parentKey: "3",
    code: "34",
    name: "الدخل الشامل الآخر المتراكم",
    type: "equity",
    isGroup: true,
  },
  ...
  { key: "522", parentKey: "52", code: "522", name: "الإعلان والتسويق", type: "expense" },
  {
    ...
    parentKey: "52",
    code: "523",
    name: "الرسوم الإضافية البنكية والمصاريف",
    type: "expense",
  },
  ...
  { key: "537", parentKey: "52", code: "537", name: "مصاريف القضايا", type: "expense" },
  {
    ...
    parentKey: "52",
    code: "538",
    name: "مصروفات تشغيلية خاصة بالمهنة",
    type: "expense",
  },

  {
    ...
    isGroup: true,
    notes:
      "أُعيد ترقيم الحسابات الفرعية إلى 5310-5350 لتفادي تعارض الأكواد مع فرع 52 المصروفات التشغيلية",
  },
  {
    key: "5310",
    parentKey: "53",
    code: "5310",
    name: "خسارة أو ربح في صرف العملات",
    type: "expense",
  },
