                    ...
                    <td className="px-4 py-2.5">
                      <div className="flex items-center gap-1 justify-end">
                        ...
                        {inv.status === "draft" && canManage && (
                          <button onClick={() => openEdit(inv)} className="text-xs font-semibold text-amber-700 hover:bg-amber-50 px-2 py-1 rounded-lg">
                            تعديل
                          </button>
                        )}
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowForm(false)}>
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl p-6 space-y-4 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex gap-2 justify-end pt-2">
              ...
              <button onClick={saveDraft} className="px-4 py-2 text-sm font-semibold text-white bg-slate-900 hover:bg-slate-700 rounded-xl">
                حفظ كمسودة
              </button>
            </div>
          </div>
            ...
            <div className="flex gap-2 justify-end pt-2 flex-wrap">
              ...
              {viewingInvoice.status === "approved" && amountDue(viewingInvoice, payments) > 0.005 && canRecordPayment && (
                <button
                  ...
                  className="px-4 py-2 text-sm font-semibold text-white bg-slate-900 hover:bg-slate-700 rounded-xl flex items-center gap-1.5"
                >
